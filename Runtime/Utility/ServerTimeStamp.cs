...
namespace ModIO
{
    public static class ServerTimeStamp
    {
        ...
        // --- CONVERSION ---
        public static long FromLocalDateTime(DateTime localDateTime)
        {
        ...
        public static long FromUTCDateTime(DateTime utcDateTime)
        {
            ...
            long serverTimeStamp = (long)utcDateTime.Subtract(UNIX_EPOCH).TotalSeconds;
        ...
        {
            get { return FromUTCDateTime(DateTime.UtcNow); }
        }
    }
}
