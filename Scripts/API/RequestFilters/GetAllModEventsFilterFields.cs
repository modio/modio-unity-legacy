namespace ModIO.API
{
    public static class GetAllModEventsFilterFields
    {
        ...
        // (boolean) Default value is true. Returns only the latest unique events, which is useful for checking if the primary modfile has changed.
        public const string latest = "latest";
        // (boolean) Default value is false. Returns only events connected to mods the authenticated user is subscribed to, which is useful for keeping the users mods up-to-date.
